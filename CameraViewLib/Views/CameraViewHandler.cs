...
#if IOS
using PlatformView = CameraViewLib.Platforms.iOS.NativeCameraView;
#elif ANDROID
using PlatformView = CameraViewLib.Platforms.Android.NativeCameraView;
#elif WINDOWS
using PlatformView = CameraViewLib.Platforms.Windows.NativeCameraView;
#else
